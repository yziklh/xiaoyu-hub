...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            agent::commands::attachment_get_download_dir,
            agent::commands::attachment_list_files,
            agent::commands::attachment_open_file,
            agent::commands::attachment_download_file,
